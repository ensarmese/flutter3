  ...
  Widget TopRated() => Container(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  LocationItem("assets/images/isü1.jpg", "İstinye üni", "1km from you", "£99k"),                  
                  LocationItem("assets/images/vadi.png", "İstinyeVadi", "1km from you", "£999k"),
                  LocationItem("assets/images/tcg.jpg", "TCG anadolu", "232m from you", "₺₺₺"),
                  LocationItem("assets/images/ss.png", "İstinyeSBF", "1km from you", "£50k"),
                  LocationItem("assets/images/köprü.jpg", "Köprü", "10km from you", "₺78,5"),
                  LocationItem("assets/images/kule.jpg", "Kız Kulesi", "2km from you", "₺500"),
        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  StoryItem("assets/images/memati.jpeg", "MematiBAŞ"),
                  StoryItem("assets/images/polat.jpeg", "POLAT"),
                  StoryItem("assets/images/süleyman.jpeg", "Çakır"),
                  StoryItem("assets/images/ramiz.jpeg", "DAYI"),
                  StoryItem("assets/images/ezel.jpeg", "Ömer"),
                  StoryItem("assets/images/abdü.jpeg", "Abdüley"),
                  StoryItem("assets/images/memati.jpeg", "MematiBAŞ"),
                  StoryItem("assets/images/polat.jpeg", "POLAT"),
                  StoryItem("assets/images/süleyman.jpeg", "Çakır"),
                  StoryItem("assets/images/ramiz.jpeg", "DAYI"),
